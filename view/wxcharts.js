...
function drawRadarLabel(angleList, radius, centerPosition, opts, config, context) {
    ...
    context.beginPath();
    context.setFontSize(config.fontSize);
    context.setFillStyle(radarOption.labelColor || 'white');
...
function drawYAxisTitle(title, opts, config, context) {
    ...
    context.beginPath();
    context.setFontSize(config.fontSize);
    context.setFillStyle(opts.yAxis.titleFontColor || 'black');
...
function drawXAxis(categories, opts, config, context) {
    ...
    context.beginPath();
    context.setStrokeStyle(opts.xAxis.gridColor || "white");
    ...
    if (config._xAxisTextAngle_ === 0) {
        context.beginPath();
        context.setFontSize(config.fontSize);
        context.setFillStyle(opts.xAxis.fontColor || 'white');
        categories.forEach(function (item, index) {
...
function drawYAxis(series, opts, config, context) {
    ...
    context.beginPath();
    context.setFontSize(config.fontSize);
    context.setFillStyle(opts.yAxis.fontColor || 'white');
...
function drawLegend(series, opts, config, context) {
    ...
    legendList.forEach(function (itemList, listIndex) {
        ...
        itemList.forEach(function (item) {
            ...
            context.beginPath();
            context.setFillStyle(opts.extra.legendTextColor || '');
...
function drawRadarDataPoints(series, opts, config, context) {
    ...
    context.beginPath();
    context.setLineWidth(1);
    context.setStrokeStyle(radarOption.gridColor || "white");
...
var Charts = function Charts(opts) {
    config.haveNum = opts.haveNum;
    config.yTitle = opts.yTitle;
    config.yValue = opts.yValue;
    config.yAxisSplit = opts.yAxisSplit;
